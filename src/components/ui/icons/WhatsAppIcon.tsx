...
/**
 * Ícone monocromático do WhatsApp (componentes.md §14).
 *
 * Não usamos `Brand` do lucide porque o desenho padrão perde contraste
 * sobre superfícies coloridas. Este aqui é um path limpo, monocromático
 * via `fill={color}`, com `strokeWidth 1.75` consistente com a família.
 *
 * Dimensão em pt controlada pela prop `size` (padrão 20, igual ao do
 * `lucide` padrão).
 */
type Props = {
  size?: number;
